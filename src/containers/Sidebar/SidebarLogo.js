...
import {onNavStyleChange, toggleCollapsedSideNav} from "../../_actions/setting";
import {
  NAV_STYLE_DRAWER,
  NAV_STYLE_FIXED,
...
export default connect(mapStateToProps, {toggleCollapsedSideNav, onNavStyleChange})(SidebarLogo);
