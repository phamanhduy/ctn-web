...
import {switchLanguage, toggleCollapsedSideNav} from "../../_actions/setting";
import SearchBox from "../../component/SearchBox";
import UserInfo from "../../component/UserInfo";
import AppNotification from "../../component/AppNotification";
import MailNotification from "../../component/MailNotification";
    ...
    return (
      <Auxiliary>
        <Header>
          ...
          <Link to="/" className="gx-d-block gx-d-lg-none gx-pointer">CTNPQ</Link>

          {/* <SearchBox styleName="gx-d-none gx-d-lg-block gx-lt-icon-search-bar-lg"
                     placeholder="Tìm khiến giảng viên ..."
...
export default connect(mapStateToProps, {switchLanguage, toggleCollapsedSideNav})(Topbar);
